...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("PENDING", "ACCEPTED", "REJECTED", name="statusenum"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["operator_id"],
            ["operators.id"],
            name=op.f("fk_operator_venues_operator_id_operators"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["venue_id"],
            ["venues.id"],
            name=op.f("fk_operator_venues_venue_id_venues"),
            ondelete="CASCADE",
        ),
